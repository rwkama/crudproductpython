...
setup(
  name = 'CrudProductPythonCarlos',         # How you named your package folder (MyLib)
  packages = ['CrudProductPythonCarlos'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/rwkama/crudproductpython/archive/v_01.tar.gz',    # I explain this later on
